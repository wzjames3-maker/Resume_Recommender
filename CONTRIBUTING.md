...
This is a private fork of MaxKB (slimmed core + HR recruitment workspace). The authoritative handoff document is [`HANDOFF.md`](HANDOFF.md) — it covers repository structure, development environment, test commands, commit conventions and the product roadmap.
