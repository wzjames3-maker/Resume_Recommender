...
urlpatterns = [
    ...
    path("workspace/<str:workspace_id>/hr/resume-databases", views.ResumeDatabaseAPI.as_view()),
    path("workspace/<str:workspace_id>/hr/resume-databases/<str:database_id>/archive", views.ResumeDatabaseArchiveAPI.as_view()),
    ...
    path("workspace/<str:workspace_id>/hr/interviews", views.InterviewListAPI.as_view()),
    ...
    path("workspace/<str:workspace_id>/hr/members", views.HrMembersAPI.as_view()),
    path("workspace/<str:workspace_id>/hr/offboarding/preview", views.HrOffboardingPreviewAPI.as_view()),
    path("workspace/<str:workspace_id>/hr/offboarding/export", views.HrOffboardingExportAPI.as_view()),
    path("workspace/<str:workspace_id>/hr/offboarding", views.HrOffboardingAPI.as_view()),
    ...
    path("workspace/<str:workspace_id>/hr/agents/runs", views.AgentRunListAPI.as_view()),
    path("workspace/<str:workspace_id>/hr/agents/runs/<str:run_id>", views.AgentRunDetailAPI.as_view()),
    path("workspace/<str:workspace_id>/hr/agents/runs/<str:run_id>/retry", views.AgentRunRetryAPI.as_view()),
    path("workspace/<str:workspace_id>/hr/agents/evidence/<str:paragraph_id>", views.AgentEvidenceParagraphAPI.as_view()),
    path("workspace/<str:workspace_id>/hr/agents/proposals", views.AgentProposalInboxAPI.as_view()),
    path("workspace/<str:workspace_id>/hr/agents/<str:agent_type>/run", views.AgentRunAPI.as_view()),
    path("workspace/<str:workspace_id>/hr/agents/stats", views.AgentStatsAPI.as_view()),
